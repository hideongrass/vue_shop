<template>
  <div>
    <!-- 面包屑导航区-->
    <bread nav1="商品管理" nav2="添加商品"></bread>
    <!-- 卡片视图区域 -->
    <el-card>
      <!-- 提示区域 -->
  ...
  methods: {
    ...
    async getCateList() {
      ...
      if (res.meta.status !== 200) {
        return this.$message.error('获取所有商品分类的数据失败')
      }
      this.catelist = res.data
      console.log(this.catelist)
    },
    // 级联选择器选项中发生变化，就会触发这个函数
    handleChange() {
    ...
    handleRemove(file) {
      ...
      // // 3.调用数组的 splice 方法 把图片信息对象 从pics 数组中删除
